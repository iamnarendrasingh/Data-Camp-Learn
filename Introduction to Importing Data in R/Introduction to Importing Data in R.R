...
#Type : 1 read csv file , utlis package 
...
#module 02  readr & data.table

#package Name : readr: read_csv & read_tsv 
#install package 
...
#7 times c as there are 7 variable 
...
urbanpop_sel <- read_excel("urbanpop.xlsx" , skip = 21 , sheet = 2 , col_names= FALSE)
